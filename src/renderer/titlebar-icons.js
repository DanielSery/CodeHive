import {
  ...
  DOT_SET_TASK_SVG, DOT_REBASE_SVG, DOT_OPEN_MERGED_PR_SVG, INSTALL_BTN_SVG,
  OPEN_DIRECTORY_SVG, OPEN_EXPLORER_SVG, CLONE_REPO_SVG, AZURE_PAT_SVG,
  GIT_APP_SVG, THEME_DARK_SVG, THEME_LIGHT_SVG, TERMINAL_SVG, UPDATE_SVG, TASK_PLACEHOLDERS_SVG,
...
const BUTTON_ICONS = {
  ...
  'btn-task-placeholders': TASK_PLACEHOLDERS_SVG,
