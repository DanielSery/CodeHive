...
export let _showRebaseDialog = null;
export let _showCherryPickDialog = null;
...
export function registerRebaseDialog(fn) { _showRebaseDialog = fn; }
export function registerCherryPickDialog(fn) { _showCherryPickDialog = fn; }
