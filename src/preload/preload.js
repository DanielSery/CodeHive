...
contextBridge.exposeInMainWorld('reposAPI', {
  ...
  watchGit: (wtPath) => ipcRenderer.send('git:watch', wtPath),
  unwatchGit: (wtPath) => ipcRenderer.send('git:unwatch', wtPath),
  onGitChanged: (cb) => ipcRenderer.on('git:changed', (_, wtPath) => cb(wtPath)),
  ...
  checkoutIdle: (wtPath) => ipcRenderer.invoke('repos:checkoutIdle', wtPath),
});
...
contextBridge.exposeInMainWorld('updaterAPI', {
  ...
  publish: (version, releaseNotes) => ipcRenderer.invoke('updater:publish', version, releaseNotes),
